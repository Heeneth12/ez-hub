    ...
    <section className="relative min-h-screen flex flex-col items-center justify-start pt-32 pb-20 bg-[#050505] overflow-hidden font-sans text-white selection:bg-purple-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-8 hover:bg-white/10 transition-colors cursor-default">
            ...
            <span className="text-xs font-medium text-gray-300 tracking-wide uppercase">Inventory OS 2.0</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <button className="h-12 px-8 rounded-full bg-white text-black font-semibold text-sm hover:scale-105 active:scale-95 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)] flex items-center gap-2">
            Start Free Trial
            <ArrowRight size={16} />
          </button>
        ...
        <div className="relative w-full max-w-5xl mx-auto perspective-1000 group">
            ...
            <div className="relative z-10 m-px rounded-xl bg-[#0a0a0a]/90 backdrop-blur-xl shadow-2xl overflow-hidden transform transition-transform duration-700 hover:scale-[1.01] hover:rotate-x-2"
