...
const features = [
  {
    ...
    description:
      "Handle all your sales and purchase activities, manage invoices and bills, track payments, and monitor packages and shipments to ensure on-time delivery.",
  ...
  },
  {
    ...
    description:
      "Control stock across multiple warehouses or godowns centrally. Track item movements, transfer stock, and generate warehouse-specific reports.",
  ...
  },
  {
    ...
    description:
      "Set up barcode systems easily. Add SKUs, serial and batch numbers, and scan items directly into sales and purchase orders.",
  ...
  },
  {
    ...
    title: "Integrations",
    description:
      "Sell on Shopify or Etsy, integrate with Zoho CRM and Zoho Books, and receive online payments via PayPal or Razorpay.",
  ...
  },
  {
    ...
    description:
      "Track spare parts, sellable items, serial numbers, batch numbers, and expiry dates with complete accuracy.",
  ...
  },
  {
    ...
    title: "Reports",
    description:
      "Analyze inventory aging, vendor payments, sales performance, and inventory valuation with downloadable and shareable reports.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            Replace your spreadsheet chaos with a unified operating system built
            for high-growth e-commerce brands.
          </p>
        </div>
