    ...
    <div className="bg-white font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-600">
      <nav className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight">Booking</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          <button className="hidden sm:block text-sm font-semibold text-slate-600 hover:text-orange-600">
            Sign Up
          </button>
          <button className="px-5 py-2.5 rounded-lg bg-orange-600 text-white text-sm font-semibold hover:bg-orange-700 transition-all shadow-lg shadow-orange-200">
            Get Started
          </button>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-12 pb-24 lg:pt-20 lg:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative isolate hidden md:block">
            ...
            {/* Main Card: Appointment List (Like the "Course" list in image) */}
            ...
            {/* Floating Pop-up Card (Like "Join Quiz" in image) */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-slate-500 text-lg leading-relaxed">
                  ...
                  your website. They pick a time, and it's added to your
                  calendar instantly.
                </p>
                <ul className="space-y-3 pt-2">
                  {[
              ...
              {[
                ...
                <div
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-full ${i === 0
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center max-w-2xl mx-auto mb-16">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <button
                    ...
                    <div
                      className={`w-6 h-6 rounded-full bg-white shadow-sm transform transition-transform duration-300 ${isAnnual ? "translate-x-6" : "translate-x-0"
                        }`}
                    />
                  </button>
                  <span
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-start">
                {plans.map((plan, i) => (
                  <div
                    key={i}
                    className={`relative p-8 rounded-2xl bg-white transition-all duration-300 ${plan.popular
